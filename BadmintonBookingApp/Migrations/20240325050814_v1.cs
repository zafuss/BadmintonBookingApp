    ...
    public partial class v1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Quantity = table.Column<int>(type: "int", nullable: false),
                    Service_ReceiptId = table.Column<int>(type: "int", nullable: false),
                    ServiceId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Service_Details", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Service_Details_Service_Receipts_Service_ReceiptId",
                        column: x => x.Service_ReceiptId,
                        principalTable: "Service_Receipts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Service_Details_Services_ServiceId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RF_Details", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RF_Details_Courts_CourtId",
                        column: x => x.CourtId,
                        principalTable: "Courts",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_RF_Details_Reservations_ReservationId",
                        column: x => x.ReservationId,
                        principalTable: "Reservations",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RF_Details_CourtId",
                table: "RF_Details",
                column: "CourtId");

            migrationBuilder.CreateIndex(
                name: "IX_RF_Details_ReservationId",
                table: "RF_Details",
                column: "ReservationId");

            migrationBuilder.CreateIndex(
                name: "IX_Service_Details_Service_ReceiptId",
                table: "Service_Details",
                column: "Service_ReceiptId");

            migrationBuilder.CreateIndex(
                name: "IX_Service_Details_ServiceId",
                table: "Service_Details",
                column: "ServiceId");
